 ...
 * @author Ivke
 */
public class DeveloperGUI extends javax.swing.JFrame {

    /**
     * Creates new form DeveloperGUI
     */
    public DeveloperGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea2.setText("Made by Mr.Stefan Ivic\n\nDate - 11/05/2015");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeveloperGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
